...
class LessonOptionDetails extends StatefulWidget {
  final Color color;
  final String text;
  final String text1;
  ...
  @override
  State<LessonOptionDetails> createState() => _LessonOptionDetailsState();
}

class _LessonOptionDetailsState extends State<LessonOptionDetails> {
